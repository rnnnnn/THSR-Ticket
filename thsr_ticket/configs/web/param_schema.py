...
class BookingModel(BaseModel):
    ...
    inbound_date: str = Field('', alias='backTimeInputField')
    inbound_time: str = Field('', alias='backTimeTable')
    to_train_id: int = Field(0, alias='toTrainIDInputField')
    back_train_id: int = Field(0, alias='backTrainIDInputField')
